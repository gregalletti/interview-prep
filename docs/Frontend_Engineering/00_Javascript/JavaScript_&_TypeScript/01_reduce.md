...
title: "🟢 Array reduce"
external_links:
    GreatFrontEnd: https://www.greatfrontend.com/questions/javascript/array-reduce
---
!!! note ""
    ...
    | --- | --- | --- |
    | `[1, 2, 3].myReduce((prev, curr) => prev + curr, 0);` | 6 | 0 + 1 + 2 + 3 = 6 |
    | `[1, 2, 3].myReduce((prev, curr) => prev + curr, 4);`  | 10 | 4 + 1 + 2 + 3 = 10 |

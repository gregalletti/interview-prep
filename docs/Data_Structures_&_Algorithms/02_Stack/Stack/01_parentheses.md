...
- **Time**: $O(n)$ _as we iterate through the string once_
- **Space**: $O(n)$ _as we store opening brackets in the stack (in the worst case, all characters are opening brackets)_
